...
copyright = pygogo.__copyright__
package_name = pygogo.__name__
...
latex_documents = [
    (
        'index', '{0}.tex'.format(package_name),
        '{0} Documentation'.format(title), author, 'manual')]
...
man_pages = [
    ('index', package_name, '{0} Documentation'.format(title), author, 1)]
...
texinfo_documents = [
    ('index', '{0}'.format(package_name), '{0} Documentation'.format(title),
    author, package_name, description, 'Miscellaneous'),
]
